...
class PasienAdapter(private val pasienList: ArrayList<Pasien>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PasienAdapter.PasienViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.pasien_list_layout, parent, false)
        return PasienViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: PasienAdapter.PasienViewHolder, position: Int) {
