...
class AddPasienActivity1 : AppCompatActivity() {
    private lateinit var binding: ActivityAddPasien1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddPasien1Binding.inflate(layoutInflater)
