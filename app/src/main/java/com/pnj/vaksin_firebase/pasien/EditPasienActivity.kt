...
class EditPasienActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.TxtEditTglLahir.setOnClickListener {
            ...
            DatePickerDialog.OnDateSetListener { view, year, monthoOfYear,dayOfMonth ->
                binding.TxtEditTglLahir.setText(
                    "" + year + "_" + (monthoOfYear + 1) + "_" + dayOfMonth)
    ...
    fun newPasien(): Map<String, Any> {
        ...
        if (dataGambar != null) {
            uploadPictureFirebase(dataGambar!!, "${nik}_${nama}")
        }
    ...
    private fun uploadPictureFirebase(img_bitmap: Bitmap, file_name: String) {
