...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAddPasien.setOnClickListener {
            val intentMain = Intent(this, AddPasienActivity1::class.java)
    ...
    private fun deletePasien(pasien: Pasien, doc_id: String) {
        ...
        builder.setMessage("Apakah ${pasien.nama} ingin dihaps ?")
            .setCancelable(false)
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                lifecycleScope.launch {
                    ...
                    val personQuery = db.collection("pasien")
                        ...
                        .whereEqualTo("penyakit bawaan", pasien.penyakit_bawaan)
                        .get()
                        .await()
